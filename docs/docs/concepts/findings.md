...
A `HostnameFinding` is an hostname found for a project. Hostname here is used as a short for _fully qualified domain name_, or _FQDN_. A hostname finding creates or updates a domain.
