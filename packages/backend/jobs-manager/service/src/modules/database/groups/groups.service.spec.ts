...
import { CreateFirstUserDto } from './groups.dto';
...
describe('Users Service', () => {
  ...
  let userService: GroupsService;
  let userModel: Model<Group>;
  ...
  beforeAll(async () => {
    ...
    userService = moduleFixture.get(GroupsService);
    userModel = moduleFixture.get<Model<Group>>(getModelToken('users'));
   ...
   * @returns
   */
  async function user(u: Partial<Group> = {}): Promise<GroupDocument> {
